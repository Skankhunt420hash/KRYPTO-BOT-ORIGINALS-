...
class Settings:
    ...
    # Optional: eigene Log-Datei für Burst-Checks.
    # Nicht gesetzt = SUPERVISOR_BOT_LOGFILE; explizit leer = Logcheck aus.
    ...
    # Paper: risk_off/paused in runtime_recovery.json zurücksetzen (opt-in; kann manuelle Locks löschen)
