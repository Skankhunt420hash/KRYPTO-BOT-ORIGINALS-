...
class Settings:
    ...
    # Paper: Pause/Risk-Off nur explizit aufheben. Manuelle Locks aus dem Panel
    # duerfen nicht automatisch verschwinden.
    ...
    # Optional: eigene Log-Datei. Explizit leer = Log-Burst-Check aus (z.B. systemd/journalctl).
    ...
    # Paper: risk_off/paused in runtime_recovery.json nur opt-in zuruecksetzen.
