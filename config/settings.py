...
class Settings:
    ...
    # Paper: optional Pause/Risk-Off aufheben (gegen Alt-Fork „MASTER AUTOHEAL“).
    # Default aus, damit manuelle /pause- und /riskoff-Sperren erhalten bleiben.
    ...
    # Optional: eigene Log-Datei; explizit leer = Log-Prüfung deaktivieren.
    ...
    # Paper: risk_off/paused in runtime_recovery.json zurücksetzen (nur explizit opt-in)
