...
class Settings:
    ...
    # Paper: Pause/Risk-Off nur explizit auto-heilen. Manuelle /pause- und
    # /riskoff-Locks muessen ohne Opt-in ueber Zyklen/Restarts erhalten bleiben.
    ...
    # Paper: risk_off/paused in runtime_recovery.json nur explizit zuruecksetzen.
