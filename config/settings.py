...
class Settings:
    ...
    # Optional: eigene Log-Datei. Unset = SUPERVISOR_BOT_LOGFILE, explizit leer = Log-Pruefung aus.
    ...
    # Paper: risk_off/paused in runtime_recovery.json zuruecksetzen (opt-in; kann manuelle Sperren loeschen)
