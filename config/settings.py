...
class Settings:
    ...
    # Paper: opt-in zum Aufheben alter Pause/Risk-Off-Locks aus Legacy-Forks.
    # Default bleibt aus, damit manuelles /pause, /riskoff und Recovery-State erhalten bleiben.
